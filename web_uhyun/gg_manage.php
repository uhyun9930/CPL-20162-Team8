...
<a class="l w-nav-link" href="#">GRAPH</a>
...
<a class="w-inline-block w-tab-link" data-w-tab="Tab 3"><div>Tab 3</div></a>
</div><div class="w-tab-content"><div class="w--tab-active w-tab-pane" data-w-tab="Tab 1">
<img class="img" src="http://uploads.webflow.com/582dbc23c34982e54bfd9491/582e66d1f5562dd3132b9fbb_1.PNG" width="133">
<img class="img" src="http://uploads.webflow.com/582dbc23c34982e54bfd9491/582e676ebcca26c24626504b_%EA%B7%BC%EB%8C%80.PNG" width="134">
<img class="img" src="http://uploads.webflow.com/582dbc23c34982e54bfd9491/582e6792e6a815951372c319_%EB%B4%84%EB%8F%99%EB%B0%B0%EC%B6%94.PNG" width="134">
<div class="w-row">
<div class="c1 w-col w-col-4 w-col-medium-4 w-col-small-4 w-col-tiny-4">
<ul>
<li>식물 명 : 꽃상추</li><li>적정 조도 :&nbsp;</li><li>적정 온도 :</li><li>적정 습도 :</li>
</ul>
</div>

<div class="c2 w-col w-col-4 w-col-medium-4 w-col-small-4 w-col-tiny-4">
<ul>
<li>식물 명 : 근대</li><li>적정 온도 :</li><li>적정 조도 :&nbsp;</li><li>적정 습도 :</li>
</ul>
</div>

<div class="t3 w-col w-col-4 w-col-medium-4 w-col-small-4 w-col-tiny-4">
<ul class="c3"><li>적정 온도 :</li><li>적정 온도 :</li><li>적정 조도 :&nbsp;</li><li>적정 습도 :</li>
</ul>
</div></div></div>
