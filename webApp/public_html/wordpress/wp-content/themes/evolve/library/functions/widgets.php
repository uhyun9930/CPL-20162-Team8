...
<div class='item active'>
	<img src='" . get_template_directory_uri() . "/library/media/images/bootstrap-slider/1.jpg' alt='' />
...
<div class='item'>
	<img src='" . get_template_directory_uri() . "/library/media/images/bootstrap-slider/2.jpg' alt='' />
	<div class='carousel-caption'>
...
<div class='item'>
	<img src='" . get_template_directory_uri() . "/library/media/images/bootstrap-slider/3.jpg' alt='' />
	<div class='carousel-caption'>
...
<div class='item'>
	<img src='" . get_template_directory_uri() . "/library/media/images/bootstrap-slider/4.jpg' alt='' />
	<div class='carousel-caption'>
