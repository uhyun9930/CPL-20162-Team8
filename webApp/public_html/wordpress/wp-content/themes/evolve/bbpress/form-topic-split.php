        ...
        <div id="split-topic-<?php bbp_topic_id(); ?>" class="bbp-topic-split">
            ...
            <form id="split_topic" name="split_topic" method="post" action="<?php the_permalink(); ?>">
                ...
                <fieldset class="bbp-form">
                    ...
                    <legend><?php printf(__('Split topic "%s"', 'evolve'), bbp_get_topic_title()); ?></legend>
                    ...
                    <div>
                        ...
                        <fieldset class="bbp-form">
                            ...
                            <div>
                                ...
                                <label for="bbp_topic_split_option_reply"><?php printf(__('New topic in <strong>%s</strong> titled:', 'evolve'), bbp_get_forum_title(bbp_get_topic_forum_id(bbp_get_topic_id()))); ?></label>
                                <input type="text" id="bbp_topic_split_destination_title" value="<?php printf(__('Split: %s', 'evolve'), bbp_get_topic_title()); ?>" tabindex="<?php bbp_tab_index(); ?>" size="35" name="bbp_topic_split_destination_title" />
                            </div>
                        ...
                        <div class="bbp-submit-wrapper">
                            <button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_merge_topic_submit" name="bbp_merge_topic_submit" class="button submit small"><?php _e('Submit', 'evolve'); ?></button>
                        </div>
                    </div>
