<?php
/**
* @version $Id: pcltrace.lib.php,v 1.2 2004/08/26 05:20:52 rcastley Exp $
* @package Mambo_4.5.1
*/
...
//   disponible. Celle-ci n'est pour le moment distribu? qu'avec l'application
//   et la librairie PhpZip.
//   Une version ind?endante sera bientot disponible sur http://www.phpconcept.net
//
// English :
...
//   * Avertissement :
//
//   Cette librairie a ??cr釪e de fa?n non professionnelle.
//   Son usage est au risque et p?il de celui qui l'utilise, en aucun cas l'auteur
//   de ce code ne pourra ?re tenu pour responsable des ?entuels d?ats qu'il pourrait
//   engendrer.
//   Il est entendu cependant que l'auteur a r?lis?ce code par plaisir et n'y a
//   cach?aucun virus, ni malveillance.
//   Cette libairie est distribu? sous la license GNU/GPL (http://www.gnu.org)
//
//   * Auteur :
//
//   Ce code a ???rit par Vincent Blavet (vincent@blavet.net) sur son temps
//   de loisir.
//
// --------------------------------------------------------------------------------
