<?php
/**
* @version $Id: pcltar.lib.php,v 1.4 2004/09/22 06:41:22 prazgod Exp $
* @package Mambo_4.5.1
*/
...
//
// Description :
//   See readme.txt (English & Fran?is) and http://www.phpconcept.net
//
// Warning :
...
//  $g_pcltar_extension = substr(strrchr(basename($PATH_TRANSLATED), '.'), 1);
  ...
  {
    include("pclerror.func.".$g_pcltar_extension);
  }
  if (!defined("PCLTRACE_LIB"))
  {
    include("pcltrace.func.".$g_pcltar_extension);
  }
  ...
  //   $p_path. The relative path of the archived files are keep and become
  //   relative to $p_path.
  //   If a directory is sp?ified in the list, all the files from this directory
  //   will be extracted.
  //   If a file with the same name already exists it will be replaced.
  //   If the path to the file does not exist, it will be created.
  //   Depending on the $p_tarname extension (.tar, .tar.gz or .tgz) the
	...
	*/
    ...
    While (!($v_end_of_file = ($p_tar_mode == "tar"?feof($v_tar):gzeof($v_tar))))
    {
      ...
      else
      {
        ...
        TrFctMessage(__FILE__, __LINE__, 4, "Position apr? jump [".($p_tar_mode=="tar"?ftell($v_tar):gztell($v_tar))."]");
      }
