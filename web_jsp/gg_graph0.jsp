...
$(function () {
    Highcharts.chart('container', {
        ...
        series: [{
            name: '온도',
            data: [23.5, 24.1, 23.9, 23.1, 22.2, 21.5, 19.2, 18.9, 16.8, 14.3, 13.9, 9.6]
        }]
    });
});
</script>
...
<a class="tab2 w--current w-inline-block w-tab-link" data-w-tab="Tab 1" href='gg_graph0.jsp'><div>온도</div></a>
...
<a class="w-inline-block w-tab-link" data-w-tab="Tab 4" href='gg_graph3.jsp'><div>토양습도</div></a>
</div>
