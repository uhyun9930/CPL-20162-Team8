 ...
 */
public class Sand extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      //  return inflater.inflate(R.layout.fragment_sand, container, false);
        View view = inflater.inflate(R.layout.fragment_sand, container, false);
        LineChart chart = (LineChart)view.findViewById(R.id.chartSand);
        Button button = (Button)view.findViewById(R.id.buttonSand);
